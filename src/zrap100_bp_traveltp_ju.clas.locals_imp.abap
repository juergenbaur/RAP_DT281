...
CLASS lhc_travel IMPLEMENTATION.
  ...
  METHOD earlynumbering_create.
    ...
    DATA:
      entity           TYPE STRUCTURE FOR CREATE ZRAP100_R_TravelTP_JU,
    ...
    ELSE.
      ...
      SELECT SINGLE FROM zrap100_atrav_JU FIELDS MAX( travel_id ) AS travelID INTO @travel_id_max.
      "Get max travel ID from draft table
      SELECT SINGLE FROM zrap100_dtrav_JU FIELDS MAX( travelid ) INTO @DATA(max_travelid_draft).
