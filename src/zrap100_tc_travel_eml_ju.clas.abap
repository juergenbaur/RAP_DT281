"! @testing BDEF:ZRAP100_R_TravelTP_JU
CLASS zrap100_tc_travel_eml_ju DEFINITION
  PUBLIC
  FINAL
...
CLASS zrap100_tc_travel_eml_ju IMPLEMENTATION.
 METHOD class_setup.
   " create the test doubles for the underlying CDS entities
   cds_test_environment = cl_cds_test_environment=>create_for_multiple_cds(
                     i_for_entities = VALUE #(
                       ( i_for_entity = 'ZRAP100_R_TravelTP_JU' ) ) ).
 ...
 ENDMETHOD.
   ...
   METHOD create_with_action.
     ...
     MODIFY ENTITIES OF ZRAP100_R_TravelTP_JU
      ENTITY Travel
...
*            FROM VALUE #( ( %cid_ref = 'ROOT1' ) )
     ...
     SELECT * FROM ZRAP100_R_TravelTP_JU INTO TABLE @DATA(lt_travel). "#EC CI_NOWHERE
