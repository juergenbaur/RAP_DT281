CLASS zrap100_cl_eml_JU DEFINITION
  PUBLIC
  FINAL
  CREATE PUBLIC .
...
CLASS zrap100_cl_eml_JU IMPLEMENTATION.
...
*    COMMIT ENTITIES
*      RESPONSE OF ZRAP100_R_TravelTP_JU
